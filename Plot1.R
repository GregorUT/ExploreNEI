...
png("plot1.png", width=640, height=480, res=120)
...
with(NEI,boxplot(Emissions~year, ylim = c(0, .3),xlab="Year", ylab= "Tons of PM2.5 / Source", outline = FALSE))
mtext("Pollution Trends in the US")
dev.off()
